...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-md w-full">
            ...
            <!-- Error Code -->
            <h1 class="text-5xl sm:text-6xl font-bold text-gray-900 mb-4">403</h1>
            ...
            <p class="text-gray-600 mb-8 text-sm sm:text-base">
                You don't have permission to access this resource. If you believe you should have access, please contact support.
            </p>
            ...
            <p class="text-gray-500 text-xs sm:text-sm mt-8">
                Error Code: 403 | If you believe this is a mistake, please contact support.
            </p>
        </div>
    </div>
</body>
